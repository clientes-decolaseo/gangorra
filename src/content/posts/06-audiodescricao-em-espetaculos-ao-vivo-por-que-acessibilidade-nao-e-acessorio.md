...
seoDescription: "Acessibilidade em espetáculos ao vivo não é detalhe opcional — é parte estrutural de uma produção cultural pública. Entenda por quê."
---
...
## Um compromisso público, não apenas legal
...
Está planejando uma produção cultural e quer incluir acessibilidade desde o início? [Fale com a Gangorra sobre audiodescrição para teatro](/servicos/audiodescricao-teatro).
